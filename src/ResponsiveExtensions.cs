...
public static class ResponsiveExtensions
{
    ...
    {
        return OnScreen(view, responsiveView, () => responsiveView.Breakpoint == BreakPoint.sm, () => action(view));
    }

    public static T OnMd<T>(this T view, ResponsiveView responsiveView, Action<T> action) where T : View
    {
        return OnScreen(view, responsiveView, () => responsiveView.Breakpoint == BreakPoint.md, () => action(view));
    }

    public static T OnLg<T>(this T view, ResponsiveView responsiveView, Action<T> action) where T : View
    {
        return OnScreen(view, responsiveView, () => responsiveView.Breakpoint == BreakPoint.lg, () => action(view));
    }

    public static T OnXl<T>(this T view, ResponsiveView responsiveView, Action<T> action) where T : View
    {
        return OnScreen(view, responsiveView, () => responsiveView.Breakpoint == BreakPoint.xl, () => action(view));
    }
